...
// figma node: 7228:7142 Action/Icon Button/Primary (15 variants)
const __venc = (v) => String(v).replace(/[%|=]/g, encodeURIComponent);
const __vkey = (p) => "size=" + __venc(p.size) + '|' + "state=" + __venc(p.state);

export function ActionIconButtonPrimary(_p = {}) {
  ...
  const __body0 = () => (
    <div className={props.className} style={{
      ...
      <div style={{
          ...
          height: 18,
          flexShrink: 0,
        }}>{props.icon ?? <IconNavHome style={{ color: "var(--color-action-on-primary)" }} />}</div>
      {props.badge && (
      <div style={{
        position: "relative",
        width: 8,
  ...
  const __body1 = () => (
    <div className={props.className} style={{
      ...
      borderRadius: 8,
      backgroundColor: "var(--color-action-primary)",
      boxShadow: "inset 0 0 0 2px var(--color-action-primary)",
      display: "flex",
      flexDirection: "row",
      justifyContent: "center",
      alignItems: "center",
  ...
  const __body6 = () => (
    <div className={props.className} style={{
      ...
      <div style={{
          ...
          height: 20,
          flexShrink: 0,
        }}>{props.icon ?? <IconNavHome style={{ color: "var(--color-action-on-primary)", transform: "scale(1.111, 1.111)", transformOrigin: "0 0" }} />}</div>
      {props.badge && (
      <div style={{
        position: "relative",
        width: 8,
