...
// figma node: 7228:7264 Action/Icon Button/Ghost (15 variants)
const __venc = (v) => String(v).replace(/[%|=]/g, encodeURIComponent);
const __vkey = (p) => "size=" + __venc(p.size) + '|' + "state=" + __venc(p.state);

export function ActionIconButtonGhost(_p = {}) {
  ...
  const __body0 = () => (
    <div className={props.className} style={{
      ...
      <div style={{
          ...
          height: 18,
          flexShrink: 0,
        }}>{props.icon ?? <IconNavHome style={{ color: "var(--color-icon-secondary)" }} />}</div>
      {props.badge && (
      <div style={{
        position: "relative",
        width: 8,
  ...
  const __body6 = () => (
    <div className={props.className} style={{
      ...
      <div style={{
          ...
          height: 20,
          flexShrink: 0,
        }}>{props.icon ?? <IconNavHome style={{ color: "var(--color-icon-secondary)", transform: "scale(1.111, 1.111)", transformOrigin: "0 0" }} />}</div>
      {props.badge && (
      <div style={{
        position: "relative",
        width: 8,
...
export default ActionIconButtonGhost;
